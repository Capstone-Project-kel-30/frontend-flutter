...
import '../../views/home/home_page.dart' as _i15;
...
import '../../views/profile/profile_page.dart' as _i17;
import '../../views/schedule/schedule_page.dart' as _i16;
...
class AppRouter extends _i18.RootStackRouter {
  ...
  final Map<String, _i18.PageFactory> pagesMap = {
    ...
    MembershipRoute.name: (routeData) {
      return _i18.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i11.MembershipPage());
    },
    ...
    ScheduleRoute.name: (routeData) {
      return _i18.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i16.SchedulePage());
    },
  ...
  List<_i18.RouteConfig> get routes => [
        ...
        _i18.RouteConfig(Landingpage.name, path: 'LandingPage'),
        _i18.RouteConfig(SignInRoute.name, path: 'signIn'),
        _i18.RouteConfig(SignUpRoute.name, path: 'signUp'),
        _i18.RouteConfig(ForgetPasswordRoute.name, path: 'forgetPassword'),
        _i18.RouteConfig(VerfikasiSignUp.name, path: 'verfikasiSignUp'),
        _i18.RouteConfig(VerfikasiForgetPassword.name,
            path: 'verfikasiForgetPassword'),
        _i18.RouteConfig(CreateNewPass.name, path: 'createNewPassword'),
        _i18.RouteConfig(HomeWrapper.name, path: 'homeWrapper', children: [
          _i18.RouteConfig(HomeRoute.name,
              path: 'home', parent: HomeWrapper.name),
          _i18.RouteConfig(ScheduleRoute.name,
              path: 'schedule', parent: HomeWrapper.name),
          _i18.RouteConfig(ProfileRoute.name,
              path: 'profile', parent: HomeWrapper.name)
        ]),
        _i18.RouteConfig(ClassRoute.name, path: 'class'),
        _i18.RouteConfig(MembershipRoute.name, path: 'membership'),
        _i18.RouteConfig(NewsletterRoute.name, path: 'newsletter'),
        _i18.RouteConfig(VideoContentRoute.name, path: 'videoContent'),
        _i18.RouteConfig(PaymentRoute.name, path: 'payment')
      ];
}
...
/// generated route for
/// [_i6.VerfikasiSignUp]
class VerfikasiSignUp extends _i18.PageRouteInfo<VerfikasiSignUpArgs> {
  VerfikasiSignUp({_i19.Key? key, required String email})
...
class VerfikasiForgetPassword
    extends _i18.PageRouteInfo<VerfikasiForgetPasswordArgs> {
  VerfikasiForgetPassword({_i19.Key? key, required String email})
...
/// generated route for
/// [_i8.CreateNewPass]
class CreateNewPass extends _i18.PageRouteInfo<void> {
...
/// generated route for
/// [_i10.ClassPage]
class ClassRoute extends _i18.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.MembershipPage]
class MembershipRoute extends _i18.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.NewsletterPage]
class NewsletterRoute extends _i18.PageRouteInfo<void> {
...
class VideoContentRoute extends _i18.PageRouteInfo<void> {
