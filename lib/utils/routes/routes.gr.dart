...
import '../../views/profile/profile_page.dart' as _i22;
...
class AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    ProfileRoute.name: (routeData) {
      return _i23.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i22.ProfilePage());
    }
  };
  ...
  List<_i23.RouteConfig> get routes => [
        ...
        _i23.RouteConfig(ProfileSeting.name, path: 'profileSeting'),
        _i23.RouteConfig(ProfileEdit.name, path: 'profileEdit'),
        _i23.RouteConfig(NewPassword.name, path: 'editProfilePassword'),
        _i23.RouteConfig(ClassRoute.name, path: 'class'),
        _i23.RouteConfig(MembershipRoute.name, path: 'membership'),
        _i23.RouteConfig(NewsletterRoute.name, path: 'newsletter'),
        _i23.RouteConfig(VideoContentRoute.name, path: 'videoContent'),
        _i23.RouteConfig(PaymentRoute.name, path: 'payment'),
        _i23.RouteConfig(MembershipDetailRoute.name, path: 'membershipDetail'),
        _i23.RouteConfig(MembershipPaymentRoute.name, path: 'membershipPayment')
      ];
}
...
class VerfikasiSignUp extends _i23.PageRouteInfo<VerfikasiSignUpArgs> {
  VerfikasiSignUp({_i24.Key? key, required String email})
...
class VerfikasiForgetPassword
  ...
  VerfikasiForgetPassword({_i24.Key? key, required String email})
...
/// generated route for
/// [_i8.CreateNewPass]
class CreateNewPass extends _i23.PageRouteInfo<void> {
...
/// generated route for
/// [_i10.ProfileSeting]
class ProfileSeting extends _i23.PageRouteInfo<void> {
...
/// generated route for
/// [_i11.ProfileEdit]
class ProfileEdit extends _i23.PageRouteInfo<void> {
...
/// generated route for
/// [_i12.NewPassword]
class NewPassword extends _i23.PageRouteInfo<void> {
...
/// generated route for
/// [_i13.ClassPage]
class ClassRoute extends _i23.PageRouteInfo<void> {
