...
import '../../views/class/class_page.dart' as _i16;
import '../../views/home/home_page.dart' as _i23;
import '../../views/membership/membership_detail_page.dart' as _i21;
import '../../views/membership/membership_page.dart' as _i17;
import '../../views/membership/membership_payment_page.dart' as _i22;
...
import '../../views/schedule/all_schedule_page.dart' as _i13;
import '../../views/schedule/offline_schedule_page.dart' as _i14;
import '../../views/schedule/online_schedule_page.dart' as _i15;
...
class AppRouter extends _i26.RootStackRouter {
  ...
  final Map<String, _i26.PageFactory> pagesMap = {
    ...
    AllScheduleRoute.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i13.AllSchedulePage());
    },
    OfflineScheduleRoute.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i14.OfflineSchedulePage());
    },
    OnlineScheduleRoute.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i15.OnlineSchedulePage());
    },
    ClassRoute.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i16.ClassPage());
    },
    MembershipRoute.name: (routeData) {
      final args = routeData.argsAs<MembershipRouteArgs>(
          orElse: () => const MembershipRouteArgs());
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: _i17.MembershipPage(key: args.key));
    },
    ...
    MembershipDetailRoute.name: (routeData) {
      ...
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i21.MembershipDetailPage(
    ...
    MembershipPaymentRoute.name: (routeData) {
      ...
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i22.MembershipPaymentPage(
              key: args.key, type: args.type, price: args.price));
    },
    HomeRoute.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i23.HomePage());
    },
  ...
  List<_i26.RouteConfig> get routes => [
        ...
        _i26.RouteConfig(AllScheduleRoute.name, path: 'allSchedulePage'),
        _i26.RouteConfig(OfflineScheduleRoute.name,
            path: 'offlineSchedulePage'),
        _i26.RouteConfig(OnlineScheduleRoute.name, path: 'onlineSchedulePage'),
        _i26.RouteConfig(ClassRoute.name, path: 'class'),
        _i26.RouteConfig(MembershipRoute.name, path: 'membership'),
        _i26.RouteConfig(NewsletterRoute.name, path: 'newsletter'),
        _i26.RouteConfig(VideoContentRoute.name, path: 'videoContent'),
        _i26.RouteConfig(PaymentRoute.name, path: 'payment'),
        _i26.RouteConfig(MembershipDetailRoute.name, path: 'membershipDetail'),
        _i26.RouteConfig(MembershipPaymentRoute.name, path: 'membershipPayment')
      ];
}
...
class VerfikasiSignUp extends _i26.PageRouteInfo<VerfikasiSignUpArgs> {
  VerfikasiSignUp({_i27.Key? key, required String email})
...
class VerfikasiForgetPassword
  ...
  VerfikasiForgetPassword({_i27.Key? key, required String email})
...
/// generated route for
/// [_i8.CreateNewPass]
class CreateNewPass extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i13.AllSchedulePage]
class AllScheduleRoute extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i14.OfflineSchedulePage]
class OfflineScheduleRoute extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i15.OnlineSchedulePage]
class OnlineScheduleRoute extends _i26.PageRouteInfo<void> {
...
/// generated route for
/// [_i16.ClassPage]
class ClassRoute extends _i26.PageRouteInfo<void> {
