...
import '../../views/class/class_page.dart' as _i7;
import '../../views/home/home_page.dart' as _i12;
import '../../views/membership/membership_page.dart' as _i8;
import '../../views/newsletter/newsletter_page.dart' as _i9;
import '../../views/on_boarding/landing_page.dart' as _i2;
import '../../views/on_boarding/on_boarding_page.dart' as _i1;
import '../../views/payment/payment_page.dart' as _i11;
import '../../views/profile/profile_page.dart' as _i14;
import '../../views/schedule/schedule_page.dart' as _i13;
import '../../views/video_content/video_content_page.dart' as _i10;
...
class AppRouter extends _i15.RootStackRouter {
  ...
  final Map<String, _i15.PageFactory> pagesMap = {
    ...
    ClassRoute.name: (routeData) {
      return _i15.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i7.ClassPage());
    },
    MembershipRoute.name: (routeData) {
      return _i15.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i8.MembershipPage());
    },
    NewsletterRoute.name: (routeData) {
      return _i15.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i9.NewsletterPage());
    },
    VideoContentRoute.name: (routeData) {
      return _i15.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i10.VideoContentPage());
    },
    PaymentRoute.name: (routeData) {
      return _i15.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i11.PaymentPage());
    },
  ...
  List<_i15.RouteConfig> get routes => [
        ...
        _i15.RouteConfig(Landingpage.name, path: 'LandingPage'),
        _i15.RouteConfig(SignInRoute.name, path: 'signIn'),
        _i15.RouteConfig(SignUpRoute.name, path: 'signUp'),
        _i15.RouteConfig(ForgetPassword.name, path: 'forgetPasswordR'),
...
class ForgetPassword extends _i15.PageRouteInfo<void> {
  const ForgetPassword() : super(ForgetPassword.name, path: 'forgetPasswordR');
