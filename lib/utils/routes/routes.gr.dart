...
class AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    MembershipDetailRoute.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i10.MembershipDetailPage());
    },
  ...
  List<_i14.RouteConfig> get routes => [
        ...
        _i14.RouteConfig(MembershipDetailRoute.name, path: 'membershipDetail')
      ];
}
...
/// generated route for
/// [_i6.MembershipPage]
class MembershipRoute extends _i14.PageRouteInfo<MembershipRouteArgs> {
  MembershipRoute({_i15.Key? key})
...
class MembershipDetailRoute extends _i14.PageRouteInfo<void> {
  const MembershipDetailRoute()
      : super(MembershipDetailRoute.name, path: 'membershipDetail');
