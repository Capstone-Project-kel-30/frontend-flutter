...
import '../../views/membership/membership_page.dart' as _i24;
...
import '../../views/video_content/video_content_page.dart' as _i25;
import '../../views/wrapper/home_inner.dart' as _i20;
  ...
  final Map<String, _i26.PageFactory> pagesMap = {
    ...
    ClassDetailRoute.name: (routeData) {
      ...
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData,
          child:
              _i16.ClassDetailPage(key: args.key, classType: args.classType));
    },
    ...
    HomeInner.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i20.HomeInner());
    },
    ...
    MembershipRoute.name: (routeData) {
      ...
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: _i24.MembershipPage(key: args.key));
    },
    VideoContentRoute.name: (routeData) {
      return _i26.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i25.VideoContentPage());
    }
  };
        ...
        _i26.RouteConfig(HomeWrapper.name, path: 'homeWrapper', children: [
          _i26.RouteConfig(HomeInner.name,
              ...
              children: [
                ...
                _i26.RouteConfig(VideoContentRoute.name,
